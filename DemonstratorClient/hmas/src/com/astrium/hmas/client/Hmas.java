...
public class Hmas implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		//final String orderItems = order.getOrderItems();
		final Map<String,OrderItem> orderItems = new HashMap<String,OrderItem>();

		/*
		 * Download the selected product by clicking on the "start" button ->
		 * FieldUpdater
		 */
		mainPanel.shopcartPanel.shopcartListPanel.shopcart_list_panel_download_column.setFieldUpdater(new FieldUpdater<EOProduct, String>() {
			@Override
			public void update(final int index, final EOProduct object, String value) {
					...
					public void onSuccess(final Map<String, Option> optionsResult) {
						...
						while (iterator.hasNext()) {
							...
							for (int k = 0; k < tokens.size(); k++) {
								...
								dialogContents.add(opt, 170, i + l);
								l = l + 20;
							}
						...
						dialogContents.setHeight(i + "px");
						dialogContents.setWidgetPosition(closeDialogBox, 230, i-50);
						...
						closeDialogBox.addClickHandler(new ClickHandler() {
							...
							public void onClick(ClickEvent event) {
								...
								item.setProductID(object.getProductID());
								...
								while (iterator.hasNext()) {
									...
									itemOptions.put("productOrderOptionsId", optionsResult.get("0").getIdGroup());
		...
		mainPanel.shopcartPanel.shopcartListPanel.shopcart_list_panel_order_submit_button.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				// TODO Auto-generated method stub
				mainPanel.shopcartPanel.shopcartListPanel.getSubmitOrderService().submitOrder(orderItems, new AsyncCallback<String>() {
