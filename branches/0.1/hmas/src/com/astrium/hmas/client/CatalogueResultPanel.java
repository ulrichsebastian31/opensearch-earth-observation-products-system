...
public class CatalogueResultPanel extends Composite implements HasText {
	...
	CellTable<CatalogueResult> catalogue_result_panel_celltable = new CellTable<CatalogueResult>();
	@UiField
	Button catalogue_result_panel_xml_show_button;
	@UiField
	Button catalogue_result_panel_add_to_shopcart;
